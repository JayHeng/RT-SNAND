 ...
 * Definitions
 ******************************************************************************/
#define FSL_EQDC_DRIVER_VERSION (MAKE_VERSION(2, 0, 1))
...
typedef struct _eqdc_config
{
    ...
    uint32_t positionModulusValue; /*!< Position modulus value. Only used when @ref enableModuloCountMode is true.
 ...
 * @code
    ...
    psConfig->enableModuloCountMode               = false;
